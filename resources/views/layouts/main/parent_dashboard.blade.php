        ...
        <div class="top-header-dashboard">
            <div class="  container  d-flex flex-wrap justify-content-between align-items-center ">
                ...
                <div class="d-flex gap-3">
                    ...
                    <span class="contact-item-phone"> 0598765432234 <i class="fas fa-phone"></i></span>
                </div>
            </div>
        </div>

        <div class="container header-row container-fluid d-flex align-items-center justify-content-between py-3 ">
                ...
                <ul class="d-flex gap-4 ms-4 align-items-center list-unstyled m-0">
                    ...
                    <li class="dropdown">
                        <a href="#" id="accountDropdown" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false" title="{{ trans('main_trans.account') }}">
                        ...
                        <ul class="dropdown-menu account-dropdown text-end" aria-labelledby="accountDropdown">
                            <li class="text-center">
                                ...
                                <p class="user-type">{{ trans('main_trans.Parent') }}</p>
                            </li>
                            <li>
