...
@section('manager_content')
    <div id="mainContent" class="transition-all with-sidebar" style="transition: margin-inline-end 0.3s ease-in-out;">
        ...
        <h3 class="teacher-header-form">{{ trans('Teacher_trans.Add_automatic_meeting') }}</h3>
        ...
        <div class="container mt-4">
            <div class="card custom-form-card-teacher">
                <div class="card-body">
                    ...
                    <form class="subject-form" action="{{ route('zoomCLasses.store') }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group-float position-relative">
                                    ...
                                    <label for=""
                                        class="float-label">{{ trans('Teacher_trans.Password') }}</label>
                                </div>
                                @error('password')
                                    <div class="error-message">
                                        <i class="fas fa-exclamation-triangle"></i>{{ $message }}
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn save-btn">{{ trans('Teacher_trans.save') }}
                            </button>
                        </div>
                    </form>
                </div>
