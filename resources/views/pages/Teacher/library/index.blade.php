...
@section('teacher_content')
            ...
            <div class="table-content-teacher tab-content" id="myTabContent">
                <div class="tab-pane fade show active" role="tabpanel">
                    <div class="header-table-teacher">
                        ...
                        <input type="search" class="form-control search-input" id="booksSearch"
    ...
    <div id="mainContent" class="transition-all with-sidebar" style="transition: margin-inline-end 0.3s ease-in-out;">
        <h3 class="teacher-title2">{{ trans('Teacher_trans.book_list') }}</h3>
        ...
        <div class="container custom-table-teacher">
            <div class="header-table-teacher">
                ...
                <div class="search-box-student text-end mb-3">
                    <input type="search" id="booksSearch" class="form-control search-input-custom"
                        placeholder="{{ trans('main_trans.search') }}">
                </div>
            </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered"> <!-- يجعل المودال بالنص -->
                            <form action="{{ route('library.destroy', $book->id) }}" method="POST">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer justify-content-center">
                                        <button type="button" class="btn btn-del">{{ trans('Grades_trans.submit') }}</button>
                                        <button type="button" class="btn btn-cancel" data-bs-dismiss="modal">{{ trans('main_trans.cancel') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
