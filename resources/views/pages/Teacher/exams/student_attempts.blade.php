    ...
    <div id="mainContent" class="transition-all with-sidebar" style="transition: margin-inline-end 0.3s ease-in-out;">
        ...
        <div class="container custom-table-teacher">
            ...
            <div class="header-attempts-teacher">
                <h3 class="std-attempts-name">{{ trans('Teacher_trans.student_name') }} : <span>{{ $student->user->name }}</span></h3>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-operations">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-2"
                                                    ...
                                                    <i class="fas fa-eye action-icon eye-icon-action"></i>{{ trans('Teacher_trans.show_answers')}}
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-2" href="#"
                                                    ...
                                                    <i class="fas fa-trash-alt action-icon delete-icon-action"></i> {{ trans('Teacher_trans.delete') }}
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('examAttempts.destroy', $attempt->id) }}" method="POST">
                                ...
                                <div class="modal-footer justify-content-center">
                                    ...
                                    <button type="button" class="btn btn-cancel" data-bs-dismiss="modal">{{ trans('Grades_trans.Close') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
