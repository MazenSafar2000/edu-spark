                            ...
                            <div class="col-md-6">
                                <div class="form-group-float position-relative ">
                                    <input type="text" name="Name_en"
                                        ...
                                        i placeholder=" " value="{{ old('Name_en', $exam->getTranslation('name', 'en')) }}" />
                                    <label for=""
                            ...
                            <div class="col-md-6">
                                <div class="form-group-float position-relative ">
                                    <input type="number" name="question_per_page"
                                        ...
                                        id="" placeholder="" value="{{ old('question_per_page', $exam->question_per_page) }}"/>
                            ...
                            <div class="col-md-6">
                                <div class="form-group-float position-relative ">
                                    <input type="number" name="maximum_grade"
                                        ...
                                        id="" placeholder="" value="{{ old('maximum_grade', $exam->maximum_grade) }}"  />
                            ...
                            <div class="col-md-12">
                                <div class="form-group-float position-relative ">
                                    ...
                                    <select name="subject_id" id="subject-select"
                                        ...
                                        <option disabled>{{ trans('Teacher_trans.select_subject') }}</option>
