...
@section('teacher_content')
    <div id="mainContent" class="transition-all with-sidebar" style="transition: margin-inline-end 0.3s ease-in-out;">
        ...
        <h3 class="teacher-header-form">اضافة سؤال جديد</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('questions.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="title" class="form-control @error('title') is-invalid @enderror" rows="3"
                                placeholder="أدخل نص السؤال">{{ old('title') }}</textarea>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <div id="answer-fields">
                                @php
                                    $answers = old(
                                        'answers',
                                        isset($question) ? json_decode($question->answers, true) : ['', ''],
                                    );
                                    $selected = old(
                                        'right_answer',
                                        isset($question)
                        ...
                        <div class="mb-3">
                            <label class="text-danger">{{ trans('Teacher_trans.degree') }} *</label>
                            <select name="score" class="form-select @error('score') is-invalid @enderror">
                                <option disabled selected>{{ trans('Teacher_trans.select_degree') }}</option>
