    ...
    function () {
        Route::middleware(['auth', 'role:parent'])->group(function () {
            ...
            Route::group(['namespace' => 'App\Http\Controllers\Parent'], function () {
                ...
                Route::get('/materials/book/{bookId}', [ParentController::class, 'bookDetails'])->name('book.details');
                Route::get('/materials/exam/{examId}', [ParentController::class, 'examDetails'])->name('exam.details');
                Route::get('/materials/homework/{homeworkId}/{studentId}', [ParentController::class, 'homeworkDetails'])->name('homework.details');
                Route::get('/materials/recordedClass/{classId}', [ParentController::class, 'recordedClassDetails'])->name('recordedClass.details');
            });
        });
    }
);
