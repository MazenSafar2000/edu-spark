...
class OnlineClassController extends Controller
{
    ...
    {
        $zoomClasses = Online_class::where('teacher_id', Auth::user()->teacher->id)->paginate(10);

        return view('pages.Teacher.onlineZoom.index', compact('zoomClasses'));
    }
    ...
    public function create()
    {
        ...
        return view('pages.Teacher.onlineZoom.create', compact('grades'));
    }
    ...
    public function createIndirect()
    {
        ...
        return view('pages.Teacher.onlineZoom.createIndirect', compact('grades'));
    }
